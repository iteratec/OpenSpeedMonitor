...
class AggregationLegacyControllerSpec extends Specification implements BuildDomainTest<Page>,
        ControllerUnitTest<AggregationLegacyController> {

    private AggregationLegacyController controllerUnderTest
