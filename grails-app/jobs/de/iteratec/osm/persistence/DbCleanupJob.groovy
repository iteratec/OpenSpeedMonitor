...
class DbCleanupJob {
    ...
    def execute() {
		Date toDeleteBefore = new DateTime().minusWeeks(configService.getDetailDataStorageTimeInWeeks()).toDate()
        dbCleanupService.deleteWaterfallsBefore(toDeleteBefore)
	}
}
