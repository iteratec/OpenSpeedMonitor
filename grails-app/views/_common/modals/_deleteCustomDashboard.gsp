...
<a href="#DeleteModal" role="button" class="btn btn-danger" data-toggle="modal" style="margin-top: 16px;">${message(code: 'de.iteratec.isocsi.dashBoardControllers.custom.delete', args: [params.dbname], default: 'Delete')}</a>
