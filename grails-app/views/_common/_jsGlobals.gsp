<script type="text/javascript">
    ...
    OpenSpeedMonitor.i18n = {
        ...
        csiDoubleError: '${message(code: 'de.iteratec.osm.csi.csvErrors.doubleError')}',
    ...
    OpenSpeedMonitor.urls = {
        ...
        aggregationShowLegacy: "${createLink(action: 'show', controller: 'aggregationLegacy')}",
        aggregationShow: "/aggregation/show",
