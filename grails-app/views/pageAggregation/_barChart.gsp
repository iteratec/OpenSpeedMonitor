<div id="chart-container">
    <div id="filter-dropdown-group">
        <div class="btn-group pull-left" data-toggle="buttons" id="stackBarSwitch">
            <label class="btn btn-sm btn-default" id="besideButton"><input type="radio" name="mode" >Beside</label>
            <label class="btn btn-sm btn-default active" id="inFrontButton"><input type="radio" name="mode" >In Front</label>
        </div>
