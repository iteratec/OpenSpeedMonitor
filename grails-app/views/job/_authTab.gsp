...
<div  id="auth_username" class="row form-group fieldcontain">
    <label for="authUsername" class="col-md-4 control-label" for="authUsername">
        <g:message code="script.authUser.label" default="User" />
    </label>
    <div class="col-md-4">
        <g:textField disabled  class="form-control" name="authUsername" id="authUsername" value="${job?.authUsername}" autocomplete="off"/>
    </div>
</div>
...
<div class="row form-group fieldcontain">
    ...
    <div class="col-md-4">
        <g:textField  class="form-control" name="authPassword" id="authPassword" value="${job?.authPassword}" type="password"/>
    </div>
</div>
