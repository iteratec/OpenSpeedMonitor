<%@ page import="de.iteratec.osm.batch.BatchActivity" %>
			...
			<div class="form-group fieldcontain ${hasErrors(bean: batchActivityInstance, field: 'domain', 'error')} ">
				...
				<div>
					...
					<span class="help-block">${hasErrors(bean: batchActivityInstance, field: 'domain', 'error')}</span>
				</div>
			</div>

			<div class="form-group fieldcontain ${hasErrors(bean: batchActivityInstance, field: 'idWithinDomain', 'error')} required">
				...
				<div>
					...
					<span class="help-block">${hasErrors(bean: batchActivityInstance, field: 'idWithinDomain', 'error')}</span>
				</div>
			</div>

			<div class="form-group fieldcontain ${hasErrors(bean: batchActivityInstance, field: 'name', 'error')} ">
				...
				<div>
					...
					<span class="help-block">${hasErrors(bean: batchActivityInstance, field: 'name', 'error')}</span>
				</div>
			</div>

			<div class="form-group fieldcontain ${hasErrors(bean: batchActivityInstance, field: 'activity', 'error')} required">
				...
				<div>
					...
					<span class="help-block">${hasErrors(bean: batchActivityInstance, field: 'activity', 'error')}</span>
				</div>
			</div>

			<div class="form-group fieldcontain ${hasErrors(bean: batchActivityInstance, field: 'startDate', 'error')} required">
				...
				<div>
					...
					<span class="help-block">${hasErrors(bean: batchActivityInstance, field: 'startDate', 'error')}</span>
				</div>
			</div>

			<div class="form-group fieldcontain ${hasErrors(bean: batchActivityInstance, field: 'status', 'error')} required">
				...
				<div>
					...
					<span class="help-block">${hasErrors(bean: batchActivityInstance, field: 'status', 'error')}</span>
				</div>
			</div>

			<div class="form-group fieldcontain ${hasErrors(bean: batchActivityInstance, field: 'progress', 'error')} ">
				...
				<div>
					...
					<span class="help-block">${hasErrors(bean: batchActivityInstance, field: 'progress', 'error')}</span>
				</div>
			</div>

			<div class="form-group fieldcontain ${hasErrors(bean: batchActivityInstance, field: 'successfulActions', 'error')} required">
				...
				<div>
					...
					<span class="help-block">${hasErrors(bean: batchActivityInstance, field: 'successfulActions', 'error')}</span>
				</div>
			</div>

			<div class="form-group fieldcontain ${hasErrors(bean: batchActivityInstance, field: 'stage', 'error')} ">
				...
				<div>
					...
					<span class="help-block">${hasErrors(bean: batchActivityInstance, field: 'stage', 'error')}</span>
				</div>
			</div>

			<div class="form-group fieldcontain ${hasErrors(bean: batchActivityInstance, field: 'progressWithinStage', 'error')} ">
				...
				<div>
					...
					<span class="help-block">${hasErrors(bean: batchActivityInstance, field: 'progressWithinStage', 'error')}</span>
				</div>
			</div>

			<div class="form-group fieldcontain ${hasErrors(bean: batchActivityInstance, field: 'failures', 'error')} required">
				...
				<div>
					...
					<span class="help-block">${hasErrors(bean: batchActivityInstance, field: 'failures', 'error')}</span>
				</div>
			</div>

			<div class="form-group fieldcontain ${hasErrors(bean: batchActivityInstance, field: 'lastFailureMessage', 'error')} ">
				...
				<div>
					...
					<span class="help-block">${hasErrors(bean: batchActivityInstance, field: 'lastFailureMessage', 'error')}</span>
				</div>
			</div>

			<div class="form-group fieldcontain ${hasErrors(bean: batchActivityInstance, field: 'endDate', 'error')} ">
				...
				<div>
					...
					<span class="help-block">${hasErrors(bean: batchActivityInstance, field: 'endDate', 'error')}</span>
				</div>
			</div>
