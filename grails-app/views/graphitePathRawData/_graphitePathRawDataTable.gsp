...
<table class="table table-bordered">
    ...
    <tr>
        ...
        <th><g:link action="index" onclick="OpenSpeedMonitor.responsiveTable.sortBy('cachedView.graphiteLabelPrefix'); return false;" >${message(code: 'graphitePathRawData.cachedView.label', default: 'Label')}</g:link></th>
    ...
    <g:each in="${graphitePathsRawData}" status="i" var="graphitePathRawDataInstance">
        <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
            ...
            <td>${fieldValue(bean: graphitePathRawDataInstance, field: "cachedView.graphiteLabelPrefix")}${fieldValue(bean: graphitePathRawDataInstance, field: "measurand.graphiteLabelSuffix")}</td>
