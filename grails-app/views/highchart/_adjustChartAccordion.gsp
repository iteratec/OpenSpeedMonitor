            ...
            <div class="accordion-inner">
                <div class="span11">
                    ...
                    <div class="row">
                        ...
                        <div class="span9"><input id="dia-title" class="input-xxlarge" type="text"
                    ...
                    <div class="row">
                        ...
                        <div class="span9">
                            <div class="input-prepend input-append">
                                ...
                                <input class="span1 content-box" id="dia-width" type="text"
                            ...
                            <div class="input-prepend input-append">
                                ...
                                <input class="span1 content-box" id="dia-height" type="text"
                    ...
                    <div id="adjust_chart_y_axis" class="row">
                        ...
                        <div class="span9">
                            <div class="input-prepend input-append ">
                                ...
                                <input class="span1 content-box" id="dia-y-axis-min" type="text"
                                       value="${yAxisMin ?: ''}">
                            ...
                            <div class="input-append input-prepend">
                                ...
                                <input class="span1 content-box" id="dia-y-axis-max" type="text"
                                       value="${yAxisMax ?: ''}">
