...
<html lang="${session.'org.springframework.web.servlet.i18n.SessionLocaleResolver.LOCALE'}">
    ...
    <body>
        ...
        <div id="fork-me">
            <a href="https://github.com/iteratec/OpenSpeedMonitor" class="github-corner" aria-label="View source on Github">
                <svg width="49" height="49" viewBox="0 0 250 250" class="github-corner-svg" aria-hidden="true">
        ...
        <!-----------------------------------------------------body-->
        <g:render template="/layouts/layoutOsmContent"/>
