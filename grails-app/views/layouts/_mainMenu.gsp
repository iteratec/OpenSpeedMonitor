	...
	<ul class="nav nav-pills">
		...
		<g:elseif test="${mainTab.equals('results')}">
			<li class="controller glyphicon glyphicon-dashboard ${controllerName.equals('eventResultDashboard')?'active':''}">
				<g:link controller="eventResultDashboard" action="showAll"><i class="fa fa-signal"></i> <g:message code="de.iteratec.isocsi.eventResultDashboard" default="Dashboard" /></g:link>
			</li>
