databaseChangeLog = {
    changeSet(author: "mmi", id: "1450880177365-2") {
        sql('''
insert into day (version, hour0weight, hour1weight, hour2weight, hour3weight, hour4weight, hour5weight, hour6weight, hour7weight, hour8weight,
...
values (1, (select weight from hour_of_day where full_hour = 0),
        ...
        (select weight from hour_of_day where full_hour = 23))
    ''')
    }
}