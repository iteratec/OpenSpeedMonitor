databaseChangeLog = {
    changeSet(author: "dkl", id: "1494576018-1") {
        addColumn(tableName: "job") {
            ...
            column(name: "option_custom_dimensions"         , type: "BOOLEAN")      {constraints(nullable: "false")}
            column(name: "option_width"                     , type: "integer")
            column(name: "option_height"                    , type: "integer")
            column(name: "option_custom_browser_dimensions" , type: "BOOLEAN")      {constraints(nullable: "false")}
