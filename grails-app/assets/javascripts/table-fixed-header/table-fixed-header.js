...
(function ($) {
    ...
    $.fn.fixedHeader = function (options) {
        ...
        return this.each(function () {
            ...
            $head.clone(true).removeClass('header').addClass('header-copy header-fixed').css({
                'position': 'fixed',
            ...
            o.find('thead.header > tr > th').each(function (i, h) {
                var w = $(h).outerWidth();
                var currentElement = o.find('thead.header-copy > tr > th:eq(' + i + ')');
                currentElement.width(w);
                currentElement.prop('id', currentElement.prop('id') + '-copy')
            });
