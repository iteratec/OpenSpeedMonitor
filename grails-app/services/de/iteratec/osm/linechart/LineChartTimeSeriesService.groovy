...
class LineChartTimeSeriesService {
        ...
        performanceLoggingService.logExecutionTime(DEBUG, "create DTO for TimeSeriesChart", 1) {
            eventResultProjections.each { EventResultProjection eventResultProjection ->
                ...
                measurands.each { measurand ->
                    ...
                    timeSeriesChartDTO.measurandGroups.put(measurand.measurandGroup, measurand.measurandGroup.unit.label)
                }
                ...
                performanceAspectTypes.each { performanceAspectType ->
                    ...
                    timeSeriesChartDTO.measurandGroups.put(MeasurandGroup.LOAD_TIMES, MeasurandGroup.LOAD_TIMES.unit.label)
                }
            }
    ...
    private void buildSeries(Double value, String identifier, Date date, String testAgent, TimeSeriesDataPointWptInfo wptInfo, String measurandName, JobGroup jobGroup,
                             MeasuredEvent measuredEvent, Location location, ConnectivityProfile connectivity,
