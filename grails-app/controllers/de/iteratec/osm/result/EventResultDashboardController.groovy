...
class EventResultDashboardController {
	...
	public final static Map<CachedView, Map<String, List<String>>> AGGREGATOR_GROUP_VALUES = ResultMeasuredValueService.getAggregatorMapForOptGroupSelect()
	 ...
	 * @since copy since: IT-188
	 */
	private static void writeCSV(List<OsmChartGraph> source, Writer target, Locale localeForNumberFormat) throws IOException
	{
