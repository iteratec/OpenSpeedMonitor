...
class Location {
	...
	*/
	...
	static constraints = {
		label(maxSize: 150)
		uniqueIdentifierForServer(nullable: true)
		dateCreated()
		active()
		valid(range: 0 .. 1)
		wptServer()
		...
		browser()
		activeagents(nullable: true)
		queuethreshold(nullable: true)
		queuethresholdgreenlimit(nullable: true)
		queuethresholdyellowlimit(nullable: true)
		queuethresholdredlimit(nullable: true)
    }
